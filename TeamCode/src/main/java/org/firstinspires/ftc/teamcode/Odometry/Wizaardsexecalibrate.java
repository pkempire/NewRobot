...
@Disabled
public class Wizaardsexecalibrate extends LinearOpMode {
    ...
    String verticalLeftEncoderName = "intakeLeft", verticalRightEncoderName = "intakeRight", horizontalEncoderName = lfName;

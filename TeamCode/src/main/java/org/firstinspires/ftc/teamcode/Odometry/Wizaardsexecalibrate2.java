...
@Disabled
public class Wizaardsexecalibrate2 extends LinearOpMode {
    ...
    String rfName = "driveFrontRight", rbName = "driveBackRight", lfName = "driveFrontLeft", lbName = "driveBackLeft";
    String verticalLeftEncoderName = "driveFrontLeft", verticalRightEncoderName = "driveFrontRight", horizontalEncoderName = "driveBackLeft";

...
@TeleOp(name="V3.0 Teleop", group="Linear Opmode")

public class Teleop_robort_V3 extends LinearOpMode {
...
//BLOCK GRIPPER====================================================================================
            ...
            if (grabberState == 3) {
                blockGrabberFront.setPosition(0.7); //note: for gobilda servos, increase turns servo Clockwise
                blockGrabberBack.setPosition(0.98);//Clockwise: viewing from infront servo, track direction of arm
            }
            ...
            if (lastPressedFlipper == 0) {
                ...
                flipperServoLeft.setPosition(0.84);//.89
                flipperServoRight.setPosition(0.16);//.11
...
// Once upon a time there was an honest shoemker. He worked as hard as he could, and still he could not make enough to keep himself and his wife. At last there came a day when he had nothing left but one piece of leather, big enough to stitch one pair of shoes.